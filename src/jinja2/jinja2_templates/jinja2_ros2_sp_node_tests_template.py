...
def test_{{ resource_name }}_random(data):
    ...
    publisher = node.create_publisher( {{ message_type_sp_to_interfacer }}, control_topic)
    ...
    subscription = node.create_subscription({{ message_type_interfacer_to_sp }}, state_topic, state_callback)
