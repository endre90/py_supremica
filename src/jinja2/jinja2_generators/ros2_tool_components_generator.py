...
templates_dir = os.path.join(root, 'jinja2_templates')
...
node_filename = os.path.join(root, 'jinja2_autogenerated', 'ros2_nodes', '{}_sp_driver.py'.format(what))
sp_to_driver_msg_filename = os.path.join(root, 'jinja2_autogenerated', 'ros2_messages', '{}_sp_to_driver.msg'.format(what))
driver_to_sp_msg_filename = os.path.join(root, 'jinja2_autogenerated', 'ros2_messages', '{}_driver_to_sp.msg'.format(what))
